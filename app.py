...
st.write(" starting building modelll....")

model = build_model()

st.write(" builded  modelll....")


model.load_weights('long_v14.h5')


st.write("  part 2 startedd....")
...
if button:
    ...
    st.write("All predictions: ", all_predictions)
